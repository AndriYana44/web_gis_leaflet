<div class="col-12">
			...
			echo form_open_multipart('irigasi/add_foto/' . $irigasi->id_irigasi) ?>
			...
			<div class="row">
				<?php foreach ($foto as $key => $value) { ?>
					<div class="col-sm-3">
						...
						<br>
						<a href="<?= base_url('irigasi/delete_foto/' . $value->id_irigasi . '/' . $value->id_galeri_irigasi) ?>" class="btn btn-xs btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin Hapus Data ini..?')">Delete</a>
					</div>
				<?php } ?>
